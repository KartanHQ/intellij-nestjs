package com.nekofar.milad.intellij.nestjs.diagnostic
...
class NestErrorReportSubmitter : ErrorReportSubmitter() {
    ...
    private fun getReportBody(events: Array<out IdeaLoggingEvent>, additionalInfo: String?): String {
        ...
        val plugin = PluginManagerCore.getPlugin(PluginId.getId("com.nekofar.milad.intellij.nestjs"))
    ...
    private fun getReportIssueUrl(title: String, body: String): URI? {
        val uriBuilder = URIBuilder("https://github.com/KartanHQ/intellij-nestjs/issues/new")
